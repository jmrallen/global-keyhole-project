...
# This code has been developped by Oleg Alexandrov and team at the NASA Ames Research Center, and has been forked from the ASP GitHub repository: StereoPipeline/src/asp/Python/scale_linescan.py. All credit for the original code goes to the original authors.
